            ...
            <div class="card-header" style="background-color: rgb(232, 232, 232) !important;">
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-12 col-md-8">
                        <h3 class="card-title">
                            <i class="nav-icon fas fa-layer-group"></i> Data THR
                        </h3>
                    </div>
                    ...
                    <div class="col-12 col-md-8 ">
                        <a
                            ...
                            @click.prevent="UploadTHR()"
                        >
                            <i class="fas fa-upload"></i> Upload THR
                        </a>
                    </div>
                </div>
            </div>
    ...
    data() {
        return {
            ...
            fields: [
                ...
                { key: 'thr', label: 'Gaji Pokok', thStyle: 'text-align: center;', tdClass: 'custom-cell text-center' },
