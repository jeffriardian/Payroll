...
class PermataExportSmm implements FromCollection, ShouldAutoSize
{
    use Exportable;
    ...
    public function collection()
    {
        ...
        "0" as column13, "0" as column14 from payroll a WHERE a.nrp IN (SELECT nrp FROM absensi_payroll_staff WHERE kantor = "SMM")');
