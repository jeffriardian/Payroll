...
class PphExportSmm implements FromCollection, WithHeadings, ShouldAutoSize
{
    use Exportable;

    public function collection()
    {
        $pph = DB::select('select @no:=@no+1 nomor, a.id, a.nik, a.nama,
