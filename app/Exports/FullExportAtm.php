...
class FullExportAtm implements FromCollection, WithHeadings, ShouldAutoSize
{
    use Exportable;
    ...
    public function collection()
    {
        ...
        a.periode_akhir from payroll a inner join pph b on a.nik = b.nik,(SELECT @no:= 0) AS no
		  WHERE a.nrp IN (SELECT nrp FROM absensi_payroll_staff WHERE kantor = "ATM") order BY nomor');
