...
class FullExportSmm implements FromCollection, WithHeadings, ShouldAutoSize
{
    use Exportable;

    public function collection()
    {
        $excell = DB::select('select @no:=@no+1 nomor, a.id, a.nik, a.nama, a.bagian, a.stapajak, a.gapok, a.premihadir, a.premiprod, a.uangjabatan, a.bonus,
        ...
        a.bruto, a.bpjskes, a.jkm, a.jkk, a.potkoperasi, a.potjhtkar, a.potpensiunkar,
        a.potlain, a.totalpotongan, a.netto, b.pph21_terutang_sebulan, (a.netto+b.pph21_terutang_sebulan) as gajipph, a.periode_awal,
        a.periode_akhir from payroll a inner join pph b on a.nik = b.nik,(SELECT @no:= 0) AS no
		  WHERE a.nrp IN (SELECT nrp FROM absensi_payroll_staff WHERE kantor = "SMM") order BY nomor');
        ...
        foreach ($excell as $excell){
            $data[] = [
                ...
                'jkm' => number_format($excell->jkm),
                'jkk' => number_format($excell->jkk),
                'bpjskes' => number_format($excell->bpjskes),
                'potjhtkar' => number_format($excell->potjhtkar),
                ...
                'pph21_terutang_sebulan' => number_format($excell->pph21_terutang_sebulan),
                'gajipph' => number_format($excell->gajipph),
                'nama1' => $excell->nama,
